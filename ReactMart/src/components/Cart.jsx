...
function Cart() {
  ...
  const roundedPrice = useSelector((state)=>state.cart.totalPrice.toFixed(2))

  return (
    <div className='flex gap-2 bg-[#c92d2d] px-5 py-[8px] rounded-[7px] text-white items-center'>
        ...
        <p className='text-[12px]'>{cartQuantity} Items | ${roundedPrice}</p>
     </div>
  )
